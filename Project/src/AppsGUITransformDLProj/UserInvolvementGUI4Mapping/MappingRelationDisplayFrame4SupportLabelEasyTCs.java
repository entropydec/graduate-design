...
public class MappingRelationDisplayFrame4SupportLabelEasyTCs extends JFrame {
...
//	public static Shape[] itemList = new Shape[5000];
	...
	public MappingRelationDisplayFrame4SupportLabelEasyTCs(String s, List<String> easyTestSetDataWithoutLabel, List<String> easyTestSetDataWithLabel, String eTestCaseSetIndexFileWithLabelinProcess) {
		init(s);
	...
	public MappingRelationDisplayFrame4SupportLabelEasyTCs(String s, String picName1, String picName2) {
		init(s);
	...
	public void init(String s) {
		...
		this.addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				...
				if(MappingRelationDisplayFrame4SupportLabelEasyTCs.saved == 0) {
...
//					System.out.println("cancel:" + JOptionPane.CANCEL_OPTION);
				...
				else if(MappingRelationDisplayFrame4SupportLabelEasyTCs.saved == 1) {
					System.exit(0);
				}
				else {
	...
	public void initNextButton() {
		...
		button_next.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				MappingRelationDisplayFrame4SupportLabelEasyTCs.currentControlMappingRelation ++;
...
//				System.out.println("### comfirmFeedback: " + comfirmFeedback);
				if(comfirmFeedback == JOptionPane.OK_OPTION) {
					...
					MappingRelationDisplayFrame4SupportLabelEasyTCs.saved = 1;
	...
	public void initRightButtonMenu() {
		...
		mDel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				MappingRelationDisplayFrame4SupportLabelEasyTCs.saved = 0;
	...
	private boolean nextMappedControls() {
		...
		int tempCurrentControlMappingRelationinOnePage = MappingRelationDisplayFrame4SupportLabelEasyTCs.currentControlMappingRelationinOnePage + 1;
		...
		if(tempCurrentControlMappingRelationinOnePage < 
			...
			MappingRelationDisplayFrame4SupportLabelEasyTCs.currentControlMappingRelationinOnePage = tempCurrentControlMappingRelationinOnePage;
		}
		else {
			...
			if(tempCurrentPageRelationIndex < this.mappingRelationCheckerInvolveUser.pageMappingRelations4AllAppsFromInitialFile.get(this.mappingRelationCheckerInvolveUser.currentAppIndex).size()) {
				...
				MappingRelationDisplayFrame4SupportLabelEasyTCs.currentControlMappingRelationinOnePage = 0;
			}
			else {
	...
	public void loadNextMappedControls() {
		...
		System.out.println(
				...
				this.mappingRelationCheckerInvolveUser.currentPageRelationIndex + ", " + 
				MappingRelationDisplayFrame4SupportLabelEasyTCs.currentControlMappingRelationinOnePage
				);
		...
		iOSXCUITestElement iosElementTemp = elementRelationListTemp.get(MappingRelationDisplayFrame4SupportLabelEasyTCs.currentControlMappingRelationinOnePage).iOSPageElement;
		...
		AndroidGUIElement androidElementTemp = elementRelationListTemp.get(MappingRelationDisplayFrame4SupportLabelEasyTCs.currentControlMappingRelationinOnePage).androidPageElement;
		...
		this.inputRectsAndRelation(controliOS, controlAndroid, MappingRelationDisplayFrame4SupportLabelEasyTCs.currentControlMappingRelationinOnePage);
...
//		}
	...
	class DisplayPanel extends JPanel{
		...
		public void paintComponent(Graphics g) {
			...
			System.out.println("=============== " + MappingRelationDisplayFrame4SupportLabelEasyTCs.index);
			for(int j = 0; j < MappingRelationDisplayFrame4SupportLabelEasyTCs.index; j ++) {
		...
		public void createNewGraphics() {
			...
			case 0:
				MappingRelationDisplayFrame4SupportLabelEasyTCs.itemList.add(new Images());
				MappingRelationDisplayFrame4SupportLabelEasyTCs.itemList.get(index).currentChoice = 0;
				break;
			case 4:
				MappingRelationDisplayFrame4SupportLabelEasyTCs.itemList.add(new Line());
				MappingRelationDisplayFrame4SupportLabelEasyTCs.itemList.get(index).currentChoice = 4;
				break;
			case 5:
				MappingRelationDisplayFrame4SupportLabelEasyTCs.itemList.add(new Rectangle());
				MappingRelationDisplayFrame4SupportLabelEasyTCs.itemList.get(index).currentChoice = 5;
				break;
			case 20:
				break;
			case 21:
			...
			MappingRelationDisplayFrame4SupportLabelEasyTCs.itemList.get(index).color = color;
			MappingRelationDisplayFrame4SupportLabelEasyTCs.itemList.get(index).width = stroke;
		...
		class MouseAction extends MouseAdapter{
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(e.getButton() == MouseEvent.BUTTON3) {
					...
					if(currentChoice == 21) {
						rightButtonMenu.show(MappingRelationDisplayFrame4SupportLabelEasyTCs.this, e.getX(), e.getY());
						currentChoice = 22;
				...
				if(currentChoice == 20) {//prepare to focus
					...
					for(int j = MappingRelationDisplayFrame4SupportLabelEasyTCs.index - 1; j >= 0; j --) {
...
//					itemList.get(index).y1 = itemList.get(index).y2 = e.getY();
			...
			public void mouseReleased(MouseEvent e) {
				...
				if((currentChoice == 4)&&(startRectangleIndex != -1)){
					...
					for(int k = MappingRelationDisplayFrame4SupportLabelEasyTCs.index - 2; k >= 0; k --) {
		...
		class MouseMotion extends MouseMotionAdapter {
			...
			public void mouseDragged(MouseEvent e) {
				...
				if((currentChoice == 4)&&(startRectangleIndex != -1)) {
					...
					for(int k = MappingRelationDisplayFrame4SupportLabelEasyTCs.index - 1; k >= 0; k --) {
