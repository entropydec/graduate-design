...
public class MappingRelationDisplayFrame4SupportIllustration extends JFrame {
...
//	public static Shape[] itemList = new Shape[5000];
	...
	public MappingRelationDisplayFrame4SupportIllustration(String s, List<String> easyTestSetDataWithoutLabel, List<String> easyTestSetDataWithLabel, String eTestCaseSetIndexFileWithLabelinProcess) {
		init(s);
	...
	public MappingRelationDisplayFrame4SupportIllustration(String s, String picName1, String picName2) {
		init(s);
	...
	public void init(String s) {
		...
		this.addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				...
				if(MappingRelationDisplayFrame4SupportIllustration.saved == 0) {
...
//					System.out.println("cancel:" + JOptionPane.CANCEL_OPTION);
				...
				else if(MappingRelationDisplayFrame4SupportIllustration.saved == 1) {
					System.exit(0);
				}
				else {
	...
	public void initNextButton() {
		...
		button_next.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				MappingRelationDisplayFrame4SupportIllustration.currentControlMappingRelation ++;
...
//				System.out.println("### comfirmFeedback: " + comfirmFeedback);
				if(comfirmFeedback == JOptionPane.OK_OPTION) {
					...
					MappingRelationDisplayFrame4SupportIllustration.saved = 1;
	...
	public void initRightButtonMenu() {
		...
		mDel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				MappingRelationDisplayFrame4SupportIllustration.saved = 0;
	...
	private boolean nextMappedControls() {
		...
		int tempCurrentControlMappingRelationinOnePage = MappingRelationDisplayFrame4SupportIllustration.currentControlMappingRelationinOnePage + 1;
		...
		if(tempCurrentControlMappingRelationinOnePage < 
			...
			MappingRelationDisplayFrame4SupportIllustration.currentControlMappingRelationinOnePage = tempCurrentControlMappingRelationinOnePage;
		}
		else {
			...
			if(tempCurrentPageRelationIndex < this.mappingRelationCheckerInvolveUser.pageMappingRelations4AllAppsFromInitialFile.get(this.mappingRelationCheckerInvolveUser.currentAppIndex).size()) {
				...
				MappingRelationDisplayFrame4SupportIllustration.currentControlMappingRelationinOnePage = 0;
			}
			else {
	...
	public void updateEasyTestSetWithLabel(String label) {
		String etcTemp = this.easyTestSetWithoutLabel.get(MappingRelationDisplayFrame4SupportIllustration.currentControlMappingRelation);
	...
	public void loadNextMappedControls() {
		...
		System.out.println(
				...
				this.mappingRelationCheckerInvolveUser.currentPageRelationIndex + ", " + 
				MappingRelationDisplayFrame4SupportIllustration.currentControlMappingRelationinOnePage
				);
		...
		iOSXCUITestElement iosElementTemp = elementRelationListTemp.get(MappingRelationDisplayFrame4SupportIllustration.currentControlMappingRelationinOnePage).iOSPageElement;
		...
		AndroidGUIElement androidElementTemp = elementRelationListTemp.get(MappingRelationDisplayFrame4SupportIllustration.currentControlMappingRelationinOnePage).androidPageElement;
		...
		this.inputRectsAndRelation(controliOS, controlAndroid, MappingRelationDisplayFrame4SupportIllustration.currentControlMappingRelationinOnePage);
...
//		}
	...
	class DisplayPanel extends JPanel{
		...
		public void paintComponent(Graphics g) {
			...
			System.out.println("=============== " + MappingRelationDisplayFrame4SupportIllustration.index);
			for(int j = 0; j < MappingRelationDisplayFrame4SupportIllustration.index; j ++) {
		...
		public void createNewGraphics() {
			...
			case 0:
				MappingRelationDisplayFrame4SupportIllustration.itemList.add(new Images());
				MappingRelationDisplayFrame4SupportIllustration.itemList.get(index).currentChoice = 0;
				break;
			case 4:
				MappingRelationDisplayFrame4SupportIllustration.itemList.add(new Line());
				MappingRelationDisplayFrame4SupportIllustration.itemList.get(index).currentChoice = 4;
				break;
			case 5:
				MappingRelationDisplayFrame4SupportIllustration.itemList.add(new Rectangle());
				MappingRelationDisplayFrame4SupportIllustration.itemList.get(index).currentChoice = 5;
				break;
			case 20:
				break;
			case 21:
			...
			MappingRelationDisplayFrame4SupportIllustration.itemList.get(index).color = color;
			MappingRelationDisplayFrame4SupportIllustration.itemList.get(index).width = stroke;
		...
		class MouseAction extends MouseAdapter{
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(e.getButton() == MouseEvent.BUTTON3) {
					...
					if(currentChoice == 21) {
						rightButtonMenu.show(MappingRelationDisplayFrame4SupportIllustration.this, e.getX(), e.getY());
						currentChoice = 22;
				...
				if(currentChoice == 20) {//prepare to focus
					...
					for(int j = MappingRelationDisplayFrame4SupportIllustration.index - 1; j >= 0; j --) {
...
//					itemList.get(index).y1 = itemList.get(index).y2 = e.getY();
			...
			public void mouseReleased(MouseEvent e) {
				...
				if((currentChoice == 4)&&(startRectangleIndex != -1)){
					...
					for(int k = MappingRelationDisplayFrame4SupportIllustration.index - 2; k >= 0; k --) {
		...
		class MouseMotion extends MouseMotionAdapter {
			...
			public void mouseDragged(MouseEvent e) {
				...
				if((currentChoice == 4)&&(startRectangleIndex != -1)) {
					...
					for(int k = MappingRelationDisplayFrame4SupportIllustration.index - 1; k >= 0; k --) {
