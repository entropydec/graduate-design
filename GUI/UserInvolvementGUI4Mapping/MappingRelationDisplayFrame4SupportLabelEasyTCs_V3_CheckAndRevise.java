...
public class MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise extends JFrame {
...
//	public List<String> easyTestSetWithoutLabel;
	...
	public String easyTestCaseSetIndexFileWithLabelinProcess_4CheckAndRevise;
	
	public static int currentControlMappingRelation = -1;
	public static int currentControlMappingRelationinOnePage = -1;
	
	public static List<IOSPage2AndroidElementRelationWithLabel> e2eRelationListWithLabel; 
	
	
	public MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise(String s, List<IOSPage2AndroidElementRelationWithLabel> easyTestSetDataWithoutLabel, List<String> easyTestSetDataWithLabel, String eTestCaseSetIndexFileWithLabelinProcess, String easyTestCaseSetIndexFileWithLabelinProcess_4CheckAndRevise) {
		init(s);
//		this.easyTestSetWithoutLabel = easyTestSetDataWithoutLabel;
		...
		this.easyTestCaseSetIndexFileWithLabelinProcess_4CheckAndRevise = easyTestCaseSetIndexFileWithLabelinProcess_4CheckAndRevise;
		this.mappingRelationCheckerInvolveUser.currentPageRelationIndex ++;
		
		this.e2eRelationListWithLabel = easyTestSetDataWithoutLabel;
		
		this.setVisible(true);
	}
	
	public MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise(String s, String picName1, String picName2) {
		init(s);
...
//	public MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise(String string_UI_NAME,
//			List<IOSPage2AndroidElementRelationWithLabel> easyTestSetDataWithoutLabel,
//			List<String> easyTestSetDataWithLabel, String easyTestCaseSetIndexFileWithLabelinProcess2) {
...
//	}
	...
	public void init(String s) {
		...
		displayArea.addKeyListener(new LabelListener());
		button_next.addKeyListener(new LabelListener());
		button_last.addKeyListener(new LabelListener());
		textField.addKeyListener(new LabelListener());
		button.addKeyListener(new LabelListener());
		...
		this.addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				...
				if(MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.saved == 0) {
...
//						mappingRelationCheckerInvolveUser.updateE2ERelationsFromCache2DataFiles();
						...
						updateEasyTestSetWithLabelToDataFile();
				...
				else if(MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.saved == 1) {
					System.exit(0);
				}
				else {
	...
	public void initInputButton() {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				button.registerKeyboardAction(this, KeyStroke.getKeyStroke(KeyEvent.VK_S, 0), JComponent.WHEN_IN_FOCUSED_WINDOW);
				...
				MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.saved = 0;
	...
	public void initNextButton() {
		...
		button_next.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				button_next.registerKeyboardAction(this, KeyStroke.getKeyStroke(KeyEvent.VK_D, 0), JComponent.WHEN_IN_FOCUSED_WINDOW);

				MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.currentControlMappingRelation ++;
				
				loadNextMappedControls();
				
				
				List<IOSElement2AndroidElementRelation> elementRelationListTemp = mappingRelationCheckerInvolveUser.pageMappingRelations4AllAppsFromInitialFile.get(mappingRelationCheckerInvolveUser.currentAppIndex).get(mappingRelationCheckerInvolveUser.currentPageRelationIndex).matchElements;
				
				if(elementRelationListTemp.size() != 0) {
					System.out.println("-------------- Have mapped controls. --------------");
					String rType = e2eRelationListWithLabel.get(currentControlMappingRelation).relationType;
					if(rType != null) {
						textField.setText(rType);
					}
					else {
						textField.setText("");
					}
					...
					System.out.println("-------------- The current Page has no mapped controls. --------------");
				}
		...
		nextButtonPanel.setBounds(600, 0, 100, 20);
	...
	public void initLastButton() {
		...
		button_last.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				button_last.registerKeyboardAction(this, KeyStroke.getKeyStroke(KeyEvent.VK_A, 0), JComponent.WHEN_IN_FOCUSED_WINDOW);
				
				MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.currentControlMappingRelation --;
				
				loadLastMappedControls();
		...
		lastButtonPanel.setBounds(500, 0, 100, 20);
...
//				System.out.println("### comfirmFeedback: " + comfirmFeedback);
				if(comfirmFeedback == JOptionPane.OK_OPTION) {
					...
					MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.saved = 1;
	...
	private boolean nextMappedControls() {
		...
		int tempCurrentControlMappingRelationinOnePage = MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.currentControlMappingRelationinOnePage + 1;
		...
		if(tempCurrentControlMappingRelationinOnePage < 
			...
			MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.currentControlMappingRelationinOnePage = tempCurrentControlMappingRelationinOnePage;
		}
		else {
			...
			if(tempCurrentPageRelationIndex < this.mappingRelationCheckerInvolveUser.pageMappingRelations4AllAppsFromInitialFile.get(this.mappingRelationCheckerInvolveUser.currentAppIndex).size()) {
				...
				MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.currentControlMappingRelationinOnePage = 0;
			}
			else {
	...
	private boolean lastMappedControls() {
		
		if(MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.currentControlMappingRelationinOnePage > 0) {
			MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.currentControlMappingRelationinOnePage --;
		}
		else {
			
			int tempCurrentPageRelationIndex = this.mappingRelationCheckerInvolveUser.currentPageRelationIndex - 1;
			
			if(tempCurrentPageRelationIndex >= 0) {
				this.mappingRelationCheckerInvolveUser.currentPageRelationIndex = tempCurrentPageRelationIndex;
				if(this.mappingRelationCheckerInvolveUser.pageMappingRelations4AllAppsFromInitialFile.get(this.mappingRelationCheckerInvolveUser.currentAppIndex).get(tempCurrentPageRelationIndex).matchElements.size() == 0) {
					MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.currentControlMappingRelationinOnePage = 0;
				}
				else {
					MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.currentControlMappingRelationinOnePage = this.mappingRelationCheckerInvolveUser.pageMappingRelations4AllAppsFromInitialFile.get(this.mappingRelationCheckerInvolveUser.currentAppIndex).get(tempCurrentPageRelationIndex).matchElements.size() - 1;
				}
			}
			else {
				int tempCurrentAppIndex = this.mappingRelationCheckerInvolveUser.currentAppIndex - 1;
				if(tempCurrentAppIndex >= 0) {
					this.mappingRelationCheckerInvolveUser.currentAppIndex = tempCurrentAppIndex;
					this.mappingRelationCheckerInvolveUser.currentPageRelationIndex = this.mappingRelationCheckerInvolveUser.pageMappingRelations4AllAppsFromInitialFile.get(this.mappingRelationCheckerInvolveUser.currentAppIndex).size() - 1;
					if(this.mappingRelationCheckerInvolveUser.pageMappingRelations4AllAppsFromInitialFile.get(this.mappingRelationCheckerInvolveUser.currentAppIndex).get(tempCurrentPageRelationIndex).matchElements.size() == 0) {
						MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.currentControlMappingRelationinOnePage = 0;
					}
					else {
	...
	public void updateEasyTestSetWithLabel(String label) {
		IOSPage2AndroidElementRelationWithLabel etcTemp = this.e2eRelationListWithLabel.get(MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.currentControlMappingRelation);
		etcTemp.relationType = label;
	}
	
	public void updateEasyTestSetWithLabelToDataFile() {
		DataFileWrite.writeEasyTestSetWithLabelBasedonControlMappingRelations2DataFile(
				this.easyTestCaseSetIndexFileWithLabelinProcess_4CheckAndRevise
				, this.mappingRelationCheckerInvolveUser.allAppsInfo
				, this.mappingRelationCheckerInvolveUser.pageMappingRelations4AllAppsFromInitialFile
				, e2eRelationListWithLabel
				);
	}
	...
	public void loadNextMappedControls() {
		...
		if(!nextMappedControlCouple) {
			MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.currentControlMappingRelation --;
			System.out.println("=========== No more control mapping relations! ==========");
			return ;
		}
		...
		iOSXCUITestElement iosElementTemp = elementRelationListTemp.get(MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.currentControlMappingRelationinOnePage).iOSPageElement;
		...
		AndroidGUIElement androidElementTemp = elementRelationListTemp.get(MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.currentControlMappingRelationinOnePage).androidPageElement;
		...
		System.out.println(iosElementTemp.EHead + "[" + iosElementTemp.locationTypeOrder + "]," + androidElementTemp.EHead + "[" + androidElementTemp.locationTypeOrder + "]");
		
		
		this.inputRectsAndRelation(controliOS, controlAndroid, MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.currentControlMappingRelationinOnePage);
//  this.inputRectsAndRelation(controliOS, controlAndroid, 0);

		//Check here!
//		String etcTemp = this.easyTestSetWithoutLabel.get(MappingRelationDisplayFrame4SupportLabelEasyTCs.currentControlMappingRelation);
...
//				+ this.mappingRelationCheckerInvolveUser.pageMappingRelations4AllAppsFromInitialFile.get(this.mappingRelationCheckerInvolveUser.currentAppIndex).get(this.mappingRelationCheckerInvolveUser.currentPageRelationIndex).androidPageFileName + ".xml");
	...
	public void loadLastMappedControls() {

		boolean lastMappedControlCouple = this.lastMappedControls();
		if(!lastMappedControlCouple) {
			MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.currentControlMappingRelation ++;
			System.out.println("=========== No more control mapping relations! ==========");
			return ;
		}
	...
	class DisplayPanel extends JPanel{
		...
		public void paintComponent(Graphics g) {
			...
			System.out.println("=============== " + MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.index);
			for(int j = 0; j < MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.index; j ++) {
		...
		public void createNewGraphics() {
			...
			case 0:
				MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.itemList.add(new Images());
				MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.itemList.get(index).currentChoice = 0;
				break;
			case 4:
				MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.itemList.add(new Line());
				MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.itemList.get(index).currentChoice = 4;
				break;
			case 5:
				MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.itemList.add(new Rectangle());
				MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.itemList.get(index).currentChoice = 5;
				break;
			case 20:
				break;
			case 21:
			...
			MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.itemList.get(index).color = color;
			MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.itemList.get(index).width = stroke;
		...
		class MouseAction extends MouseAdapter{
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(e.getButton() == MouseEvent.BUTTON3) {
					...
					if(currentChoice == 21) {
						rightButtonMenu.show(MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.this, e.getX(), e.getY());
						currentChoice = 22;
				...
				if(currentChoice == 20) {//prepare to focus
					...
					for(int j = MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.index - 1; j >= 0; j --) {
...
//					itemList.get(index).y1 = itemList.get(index).y2 = e.getY();
			...
			public void mouseReleased(MouseEvent e) {
				...
				if((currentChoice == 4)&&(startRectangleIndex != -1)){
					...
					for(int k = MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.index - 2; k >= 0; k --) {
		...
		class MouseMotion extends MouseMotionAdapter {
			...
			public void mouseDragged(MouseEvent e) {
				...
				if((currentChoice == 4)&&(startRectangleIndex != -1)) {
					...
					for(int k = MappingRelationDisplayFrame4SupportLabelEasyTCs_V3_CheckAndRevise.index - 1; k >= 0; k --) {
...
//			imageEnd = (BufferedImage) PictureTransform.changePictureSize(focusedLabelName, PictureTransform.INT_ANDROID_PLATFORM);
	...
	class LabelListener extends KeyAdapter {
		...
		public void keyPressed(KeyEvent e) {
			...
			if (code.equals("1")) {
				textField.setText("type-10");
			} else if (code.equals("2")) {
				textField.setText("type-11");
			} else if (code.equals("3")) {
				textField.setText("type-12");
			} else if (code.equals("5")) {
				textField.setText("type-20");
			} else if (code.equals("6")) {
				textField.setText("type-21");
			} else if (code.equals("7")) {
				textField.setText("type-22");
			} else if (code.equals("8")) {
				textField.setText("type-23");
			} else if (code.equals("0")) {
				textField.setText("type-31");
			}
		}
